...
<head>
	...
	<script type="text/javascript">
		var self='/Admin/coupon/index';
		var url='/Admin/Coupon';
    ...
    <div class="page-content fill-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="btn-group">
                        <a id="sample_editable_1_new" class="btn green" <?php if(!empty($_GET['p'])): ?>href="/Admin/Coupon/add?id=<?php echo ($_GET['id']); ?>&p=<?php echo ($_GET['p']); ?>"<?php else: ?> href="/Admin/Coupon/add?id=<?php echo ($_GET['id']); ?>&p=1"<?php endif; ?>>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample_2" aria-describedby="sample_1_info">
                        ...
                        <?php if(is_array($arclist)): $i = 0; $__LIST__ = $arclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX <?php if($key%2==0){echo 'odd';}else{echo 'even';} ?>">
                                ...
                                <td class="text text-center">
                                    <!-- <a href="/Admin/Coupon/check?id=<?php echo ($vo["id"]); ?>" class="btn mini">查看</a> -->
                                    <a href="/Admin/Coupon/add?id=<?php echo ($vo["id"]); ?>&p=<?php echo ($_GET['p']); ?>" class="btn blue mini">编辑</a>
                                    <?php if(($vo["status"]) == "0"): ?><a href="/Admin/Coupon/status?id=<?php echo ($vo["id"]); ?>&t=forbidden&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn black mini">禁用</a>
                                        <?php else: ?>
                                        <a href="/Admin/Coupon/status?id=<?php echo ($vo["id"]); ?>&t=enable&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn yellow mini">启用</a><?php endif; ?>
                                    <a href="javascript:void(0);" data-role="/Admin/Coupon/status?id=<?php echo ($vo["id"]); ?>&t=delete&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn red mini btn-del">删除</a>
                                </td>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/coupon/index',{l:$uri},function(d){
        ...
        $('#btn-enable,#btn-forbidden,#btn-delete').click(function(e){
            ...
            if($q!=''){
                ...
                $.post('/Admin/Coupon/status',{k:$q,t:$t,p:$p},function(data){
                    window.location.reload();
                });
            }else{
