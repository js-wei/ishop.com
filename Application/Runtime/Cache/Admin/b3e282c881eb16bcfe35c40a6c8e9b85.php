...
<div class="page-container">
    ...
    <!-- END SIDEBAR -->
    <!-- BEGIN PAGE -->
    <div class="page-content fill-content page-404-full-page">
        ...
        <div class="span12 page-404">
            ...
            <div class="details">
                <h3>对不起，页面迷路了！</h3>
                <p><span id="secend"><?php echo ($waitSecond); ?></span>秒后，返回到原页面。等不及了，<a href="javascript:void(0);" onclick="window.history.go(-1);">返回到原页面</a></p>
            </div>
        </div>
        <!-- END PAGE CONTAINER-->
    </div>
 ...
 <script type="text/javascript">
   window.onload=function(){
    ...
    function setTime(){
      var e = document.getElementById('secend');
      if( e.innerHTML>0){
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/Config/',{l:$uri},function(d){
        ...
        $('#btn-enable,#btn-forbidden,#btn-delete').click(function(e){
            ...
            $q = $q.substr(1);
            if($q!=''){
                $.post('/Admin/Config/status',{k:$q,t:$t},function(data){
                    window.location.reload();
                });
            }else{
