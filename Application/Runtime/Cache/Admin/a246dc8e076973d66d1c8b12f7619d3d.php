...
<head>
	...
	<script type="text/javascript">
		var self='/Admin/Carousel/add?id=3&amp;p=';
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/Admin/Carousel/index?id=<?php echo ($_GET['id']); ?>"><?php echo ($breadcrumb); ?></a>
                        </li>
                ...
                <div class="span12">
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i><?php echo ((isset($model["name"]) && ($model["name"] !== ""))?($model["name"]):'添加轮播图'); ?></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/Admin/Carousel/add_carousel" method="post" id="form_sample_4" class="form-horizontal" novalidate="novalidate"  enctype="multipart/form-data">
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/Carousel/add?id=3&amp;p=',{l:$uri},function(d){
