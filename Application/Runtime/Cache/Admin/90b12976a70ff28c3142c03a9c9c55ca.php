...
<script type="text/javascript">
    ...
    <div class="page-content fill-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12"> 
                <label class="alert alert-error">!此操作会影响您的网站浏览,开发完成后请谨慎操作或联系管理人员进行操作</label>
                    <div class="btn-group">
                ...
                <div class="span12">
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample_2" aria-describedby="sample_1_info">
                        ...
                        <tr role="row" id="dis-sort-simple">
                            ...
                            <th class="hidden-480 sorting_disabled" role="columnheader" rowspan="1" colspan="1" style="width: 120px;">英文名</th>
                            <th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1"  >说明</th>
                            <th class="hidden-480 sorting_disabled" role="columnheader" rowspan="1" colspan="1"  style="width: 110px;">图标</th>
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX <?php if($key%2==0){echo 'odd';}else{echo 'even';} ?>">
                                ...
                                <td class="hidden-480 text-center"><?php if(($vo["show"]) == "1"): ?><label class="label label-error">不显示</label><?php else: ?><label class="label label-success">显示</label><?php endif; ?></td>
                                ...
                                <td class="text text-center">
                                    <a href="/Admin/Column/edit?id=<?php echo ($vo["id"]); ?>" class="btn blue mini">编辑</a>
                                    <?php if(($vo["status"]) == "0"): ?><a href="/Admin/Column/status?id=<?php echo ($vo["id"]); ?>&t=forbidden&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn black mini">禁用</a>
                                        <?php else: ?>
                                        <a href="/Admin/Column/status?id=<?php echo ($vo["id"]); ?>&t=enable&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn yellow mini">启用</a><?php endif; ?>
                                    <a href="javascript:void(0);" data-role="/Admin/Column/status?id=<?php echo ($vo["id"]); ?>&t=delete&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn red mini btn-del">删除</a>
                                </td>
