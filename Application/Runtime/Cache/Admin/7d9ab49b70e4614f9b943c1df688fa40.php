...
<head>
	...
	<script type="text/javascript">
		var self='/Admin/Carousel/index';
		var url='/Admin/Carousel';
    ...
    <div class="page-content fill-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="btn-group">
                        <a id="sample_editable_1_new" class="btn green" <?php if(!empty($_GET['p'])): ?>href="/Admin/Carousel/add?id=<?php echo ($_GET['id']); ?>&p=<?php echo ($_GET['p']); ?>"<?php else: ?> href="/Admin/Carousel/add?id=<?php echo ($_GET['id']); ?>&p=1"<?php endif; ?>>
                ...
                <div class="span12">
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample_2" aria-describedby="sample_1_info">
                        ...
                        <tr role="row" id="dis-sort-simple">
                            ...
                            <th class="hidden-480 sorting" style="width:30px;">编号</th>
                            <th class="sorting_disabled span4"  tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" >标题</th>
                            <th class="hidden-480 " style="width:150px;" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" >说明</th>
							<th class="hidden-480" >图片</th>
                            <th class="hidden-480" style="width:30px;">状态</th>
                        ...
                        <?php if(is_array($arclist)): $i = 0; $__LIST__ = $arclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX <?php if($key%2==0){echo 'odd';}else{echo 'even';} ?>">
                                ...
                                <td class="hidden-480">
                                    <span style="cursor:pointer;display:block;height:20px;line-height:20px;" class="tooltips" data-placement="right" data-original-title="<?php echo ($vo["description"]); ?>"><?php echo (sub_str(strip_tags(htmlspecialchars_decode($vo["description"])),0,10)); ?></span>
                                </td>
                                <td class="hidden-480">
                                	<?php if(!empty($vo["image"])): ?><a class="fancybox-button" data-rel="fancybox-button" title="<?php echo ($vo["title"]); ?>" href="<?php echo ($vo["image"]); ?>">
												<div class="zoom">
													<img src="<?php echo ($vo["thumb"]); ?>" alt="<?php echo ($vo["title"]); ?>" style="width:80px;height:30px;"/>
                                ...
                                <td class="text text-center">
                                    <!-- <a href="/Admin/Carousel/check?id=<?php echo ($vo["id"]); ?>" class="btn mini">查看</a> -->
                                    <a href="/Admin/Carousel/add?id=<?php echo ($vo["id"]); ?>&p=<?php echo ($_GET['p']); ?>" class="btn blue mini">编辑</a>
                                    <?php if(($vo["status"]) == "0"): ?><a href="/Admin/Carousel/status?id=<?php echo ($vo["id"]); ?>&t=forbidden&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn black mini">禁用</a>
                                        <?php else: ?>
                                        <a href="/Admin/Carousel/status?id=<?php echo ($vo["id"]); ?>&t=enable&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn yellow mini">启用</a><?php endif; ?>
                                    <a href="javascript:void(0);" data-role="/Admin/Carousel/status?id=<?php echo ($vo["id"]); ?>&t=delete&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn red mini btn-del">删除</a>
                                </td>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/Carousel/index',{l:$uri},function(d){
        ...
        $('#btn-enable,#btn-forbidden,#btn-delete').click(function(e){
            ...
            if($q!=''){
                ...
                $.post('/Admin/Carousel/status',{k:$q,t:$t,p:$p},function(data){
                    window.location.reload();
                });
            }else{
