                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="/Admin/Flink/index?id=<?php echo ($_GET['id']); ?>"><?php echo ($column["title"]); ?></a>
                        </li>
                ...
                <div class="span12">
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i><?php echo ((isset($model["name"]) && ($model["name"] !== ""))?($model["name"]):'添加轮友情链接'); ?></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/Admin/Flink/add_flink" method="post" id="form_sample_4" class="form-horizontal" novalidate="novalidate"  enctype="multipart/form-data">
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/Flink/add?id=1&amp;p=',{l:$uri},function(d){
