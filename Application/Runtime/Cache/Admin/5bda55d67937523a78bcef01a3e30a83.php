                ...
                <div class="span12">
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i><?php echo ((isset($model["name"]) && ($model["name"] !== ""))?($model["name"]):'修改密码'); ?></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/Admin/User/setPasswordHandler" method="post" id="form_sample_7" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/User/setPassword',{l:$uri},function(d){
        ...
        $('#btn-enable,#btn-forbidden,#btn-delete').click(function(e){
            ...
            $q = $q.substr(1);
            if($q!=''){
                $.post('/Admin/User/status',{k:$q,t:$t},function(data){
                    window.location.reload();
                });
            }else{
