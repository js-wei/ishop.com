                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            ...
                            <a href="/Admin/Single/index?id=<?php echo ($_GET['id']); ?>"><?php echo ($column["title"]); ?></a>
                        </li>
                ...
                <div class="span12">
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i><?php echo ((isset($column["title"]) && ($column["title"] !== ""))?($column["title"]):'添加控制器'); ?></div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="/Admin/Single/Insert" method="post" id="form_sample_3" class="form-horizontal" novalidate="novalidate"  enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden" name="column_id" value="<?php echo ($_GET['id']); ?>">
...
<script type="text/javascript">
    $(function(){
        ...
        $('form').submit(function(e){
            ...
            $.post('/Admin/Single/Insert',$('form').serialize(),function(data){
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/Single/index?id=17',{l:$uri},function(d){
                    window.location.reload();
                });
            });
		});
        ...
        $('#btn-enable,#btn-forbidden,#btn-delete').click(function(e){
            ...
            $q = $q.substr(1);
            if($q!=''){
                $.post('/Admin/Single/status',{k:$q,t:$t},function(data){
                    window.location.reload();
                });
            }else{
