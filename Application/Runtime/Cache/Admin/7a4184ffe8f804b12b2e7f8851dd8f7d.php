...
<head>
	...
	<script type="text/javascript">
		var self='/Admin/Article/index?id=4';
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <form action="/Admin/Article/index"  method="get" id="form-search" class="form-horizontal">
                        <div class="span9">
                            <style type="text/css">
                                select.m-wrap.small {
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                   <select name="status" class="m-wrap small" style="width:80px; height:34px">
                                    ...
                                    <a href="/Admin/Article/index?id=<?php echo ($_GET['id']); ?>" class="btn yellow" >全部</a>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="btn-group">
                        <a id="sample_editable_1_new" class="btn green" <?php if(!empty($_GET['p'])): ?>href="/Admin/Article/add?id=<?php echo ($_GET['id']); ?>&p=<?php echo ($_GET['p']); ?>"<?php else: ?> href="/Admin/Article/add?id=<?php echo ($_GET['id']); ?>&p=1"<?php endif; ?>>
                ...
                <div class="span12">
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample_2" aria-describedby="sample_1_info">
                        ...
                        <tr role="row" id="dis-sort-simple">
                            ...
                            <th class="hidden-480 sorting_disabled"  rowspan="1" colspan="1" >关键词</th>
                            <th class="hidden-480 sorting" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" >说明</th>
                        ...
                        <?php if(is_array($arclist)): $i = 0; $__LIST__ = $arclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX <?php if($key%2==0){echo 'odd';}else{echo 'even';} ?>">
                                ...
                                <td class="hidden-480"><?php echo ++$key;?></td>
                                <td style="width:100px;"><span style="cursor:pointer;display:block;height:20px;line-height:20px;" class="tooltips" data-placement="right" data-original-title="<?php echo ($vo["title"]); ?>"><?php echo (sub_str(strip_tags($vo["title"]),0,5)); ?></td>
                                <td class="hidden-480"><span style="cursor:pointer;display:block;height:20px;line-height:20px;" class="tooltips" data-placement="right" data-original-title="<?php echo ($vo["keywords"]); ?>"><?php echo (sub_str(strip_tags($vo["keywords"]),0,8)); ?></td>
                                <td class="hidden-480">
                                    <span style="cursor:pointer;display:block;height:20px;line-height:20px;" class="tooltips" data-placement="right" data-original-title="<?php echo ($vo["description"]); ?>"><?php echo (sub_str(strip_tags(htmlspecialchars_decode($vo["description"])),0,8)); ?></span>
                                </td>
                                <td class="hidden-480 "><?php echo (get_column($vo["column_id"])); ?></td>
                                <td class="hidden-480 text-center"><?php echo ($vo["hits"]); ?></td>
                                ...
                                <td class="text text-center">
                                    <!-- <a href="/Admin/Article/check?id=<?php echo ($vo["id"]); ?>" class="btn mini">查看</a> -->
                                    <a href="/Admin/Article/edit?aid=<?php echo ($vo["id"]); ?>&id=<?php echo ($vo["column_id"]); ?>&p=<?php echo ($_GET['p']); ?>" class="btn blue mini">编辑</a>
                                    <?php if(($vo["status"]) == "0"): ?><a href="/Admin/Article/status?id=<?php echo ($vo["id"]); ?>&t=forbidden&p=<?php echo ($_GET['p']); ?>&ajax=0&cid=<?php echo ($_GET['id']); ?>" class="btn black mini">禁用</a>
                                        <?php else: ?>
                                        <a href="/Admin/Article/status?id=<?php echo ($vo["id"]); ?>&t=enable&p=<?php echo ($_GET['p']); ?>&ajax=0&cid=<?php echo ($_GET['id']); ?>" class="btn yellow mini">启用</a><?php endif; ?>
                                    <a href="javascript:void(0);" data-role="/Admin/Article/status?id=<?php echo ($vo["id"]); ?>&t=delete&p=<?php echo ($_GET['p']); ?>&ajax=0&cid=<?php echo ($_GET['id']); ?>" class="btn red mini btn-del">删除</a>
                                </td>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/Article/index?id=4',{l:$uri},function(d){
