                    ...
                    <div class="span12">
                        <div class="portlet box purple">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="/Admin/Control/addhandler" method="post" id="form_sample_3" class="form-horizontal" novalidate="novalidate"  enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" id="control-name" data-required="1" class="span4 m-wrap" placeholder="控制器名称">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title" id="control-title" data-required="1" class="span4 m-wrap" placeholder="控制器英文名">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">控制器说明</label>
                                        <div class="controls">
                                            <textarea name="info" class="span4 m-wrap" placeholder="控制器说明"></textarea>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="radio">
                                                <input type="radio" name="show"  value="0" checked>显示
                                            </label>
                                            <label class="radio">
                                                <input type="radio" name="show"  value="1">不显示
                                            </label>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="ico" value="" placeholder="控制器图标"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">控制器排序</label>
                                        <div class="controls">
                                            <input type="text" name="sort" value="100" placeholder="控制器排序"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/Control/add',{l:$uri},function(d){
