...
<script type="text/javascript">
    ...
    <div class="page-content fill-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="/Admin/Control/index">查看栏目</a>
                        </li>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample_2" aria-describedby="sample_1_info" data-size="<?php echo count($list); ?>">
                        <thead>
                        <tr role="row" id="dis-sort-simple">
                            ...
                            <th class="hidden-480" style="width:70px;">编号</th>
                            <th class="sorting_disabled" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" >中文名</th>
                            <th class="hidden-480 sorting_disabled" role="columnheader" rowspan="1" colspan="1" >英文名</th>
                            <th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" >说明</th>
                            <th class="hidden-480 sorting_disabled" role="columnheader" rowspan="1" colspan="1">图标</th>
                        ...
                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                            ...
                            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX <?php if($key%2==0){echo 'odd';}else{echo 'even';} ?>">
                                    ...
                                    <td class="hidden-480">
                                        <span style="cursor:pointer;display:block;height:20px;line-height:20px;" class="tooltips" data-placement="right" data-original-title="<?php echo ($vo["info"]); ?>"><?php echo (sub_str(strip_tags(htmlspecialchars_decode($vo["info"])),0,8)); ?></span>
                                    </td>
                                    <td class="hidden-480 "><?php echo ($vo["ico"]); ?></td>
                                    <td class="hidden-480 text-center"><?php if(($vo["show"]) == "1"): ?><label class="label label-error">否</label><?php else: ?><label class="label label-success">是</label><?php endif; ?></td>
                                    ...
                                    <td class="text-center">
                                        <a href="/Admin/Control/edit?id=<?php echo ($vo["id"]); ?>" class="btn blue mini">编辑</a>
                                        <?php if(($vo["status"]) == "0"): ?><a href="/Admin/Control/status?id=<?php echo ($vo["id"]); ?>&t=forbidden&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn black mini">禁用</a>
                                            <?php else: ?>
                                            <a href="/Admin/Control/status?id=<?php echo ($vo["id"]); ?>&t=enable&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn yellow mini">启用</a><?php endif; ?>
                                        <a href="javascript:void(0);" data-role="/Admin/Control/status?id=<?php echo ($vo["id"]); ?>&t=delete&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn red mini btn-del">删除</a>
                                    </td>
