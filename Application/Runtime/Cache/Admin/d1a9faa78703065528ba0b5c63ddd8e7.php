    ...
    <div class="page-content fill-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="btn-group">
                        <a id="sample_editable_1_new" class="btn green" <?php if(!empty($_GET['p'])): ?>href="/Admin/Ad/add?id=<?php echo ($_GET['id']); ?>&p=<?php echo ($_GET['p']); ?>"<?php else: ?> href="/Admin/Ad/add?id=<?php echo ($_GET['id']); ?>&p=1"<?php endif; ?>>
                ...
                <div class="span12">
                    <table class="table table-striped table-bordered table-hover dataTable" id="sample_2" aria-describedby="sample_1_info">
                        ...
                        <?php if(is_array($arclist)): $i = 0; $__LIST__ = $arclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX <?php if($key%2==0){echo 'odd';}else{echo 'even';} ?>">
                                ...
                                <td class="hidden-480">
                                	<?php echo (get_coloumn($vo["column_id"])); ?>
                                </td>
                                ...
                                <td class="hidden-480"><?php if(($vo["effective"]) == "0"): ?>永久<?php else: echo (date('Y-m-d',$vo["effective"])); endif; ?></td>
                                <td class="text text-center">
                                    <a href="/Admin/Ad/add?id=<?php echo ($vo["id"]); ?>&p=<?php echo ($_GET['p']); ?>" class="btn blue mini">编辑</a>
                                    <?php if(($vo["status"]) == "0"): ?><a href="/Admin/Ad/status?id=<?php echo ($vo["id"]); ?>&t=forbidden&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn black mini">禁用</a>
                                        <?php else: ?>
                                        <a href="/Admin/Ad/status?id=<?php echo ($vo["id"]); ?>&t=enable&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn yellow mini">启用</a><?php endif; ?>
                                    <a href="javascript:void(0);" data-role="/Admin/Ad/status?id=<?php echo ($vo["id"]); ?>&t=delete&p=<?php echo ($_GET['p']); ?>&ajax=0" class="btn red mini btn-del">删除</a>
                                </td>
	...
	<script type="text/javascript">
		$(function(){
            ...
            $('#change-lang li').click(function(e){
                ...
                $.post('/Admin/ad/index',{l:$uri},function(d){
        ...
        $('#btn-enable,#btn-forbidden,#btn-delete').click(function(e){
            ...
            if($q!=''){
                ...
                $.post('/Admin/Ad/status',{k:$q,t:$t,p:$p},function(data){
                    window.location.reload();
                });
            }else{
