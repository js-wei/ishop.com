    ...
    <div class="row">
        <div class="col-xs-12 col-lg-4 col-md-4 col-lg-offset-4 col-md-offset-4  register-link-bold register-link-margin">
            <div class="text-center register-link">
                <a href="<?php echo U('/login');?>" class="register-link active">普通登录 </a>|<a href="<?php echo U('/login1');?>">验证码登录</a>
            </div>
            <form action="<?php echo U('user/login_handler');?>" role="form" autocomplete="off">
                ...
                <div class="form-group">
                	...
                	<div class="col-xs-12 col-md-12 col-lg-12 ">
                		<a href="<?php echo U('/register');?>" class="click pull-left margin-top-20">没有账号?现在注册</a>
                		<a href="<?php echo U('user/forget_email');?>" class="click pull-right margin-top-20">忘记密码?找回密码</a>
                	</div>
                </div>
            </form>
        </div>
