...
return array(
    ...
    'URL_ROUTE_RULES' => array( //定义路由规则
		'register'								=>'User/register?m=tel',
		'register1'								=>'User/register?m=acc',
		'login'									=>'User/login?m=acc',
		'login1'								=>'User/login?m=tel',
		'address'								=>'User/address',
		'order'									=>'User/order',
		'coupon'								=>'User/coupon',
		'tickling'								=>'User/tickling',
		'message'								=>'User/message',
		'about'									=>'User/about',
		'enshrine'								=>'User/enshrine',
		'find_passwords'						=>'User/find_passwords',
...
//      '/^(\w+)\/(\w+)$/'				    	=>'News/index?id=:1&cid=:2',
	...
	'HTML_CACHE_TIME'=>60*60*5,
	'SESSION_PREFIX'=>'member',
